...
To learn more before you start working with `ree-lending-demo`, see the following documentation available online:
...
- [Candid Introduction](https://internetcomputer.org/docs/motoko/icp-features/candid-serialization)
